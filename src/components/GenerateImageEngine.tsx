...
export function GenerateImageEngine() {
  return (
    <div className="w-full bg-[#1C1C1E] rounded-3xl p-8 border-2 border-dashed border-purple-500/30 hover:border-purple-500/60 transition-colors">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 flex flex-col space-y-6">
          ...
          <div>
            ...
            <p className="text-gray-400">单图秒变大片</p>
          </div>

          {/* Parameters Configuration Area */}
          <div className="border border-gray-800 bg-black/50 rounded-2xl p-6 flex-1 flex flex-col gap-4">
            <div className="text-gray-500 flex items-center justify-center bg-[#1C1C1E] rounded-xl h-16 border border-gray-800/50 hover:border-gray-600 transition-colors cursor-pointer border-dashed">
              <span>点击上传服装图片</span>
            </div>
            <div className="text-gray-500 flex items-center justify-center bg-[#1C1C1E] rounded-xl h-16 border border-gray-800/50 hover:border-gray-600 transition-colors cursor-pointer">
              <span>+ 选择模特</span>
            </div>
          </div>
        ...
        <div className="lg:col-span-1 flex flex-col">
          <div className="bg-gray-900 rounded-2xl border border-gray-800 aspect-[3/4] w-full relative flex items-center justify-center overflow-hidden">
